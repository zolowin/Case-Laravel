            ...
            <div class="container">
                ...
                <div class="row">
                    <div style="display: table; margin: auto;">
                        <span class="step step_complete"> <a href="{{ route('list.shopping.cart') }}" class="check-bc">Cart</a> <span class="step_line step_complete"> </span> <span class="step_line backline"> </span> </span>
                        <span class="step step_complete"> <a href="{{ route('checkout.shopping') }}" class="check-bc">Checkout</a> <span class="step_line "> </span> <span class="step_line step_complete"> </span> </span>
                    </div>
                </div>
                <div class="row">
                    <p></p>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-push-6 col-sm-push-6">
                    ...
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            Review Order <div class="pull-right"><small><a class="afix-1" href="{{ route('list.shopping.cart') }}">Edit Cart</a></small></div>
                        </div>
                        <div class="panel-body">
                            @foreach($products as $product)
                            <div class="form-group">
                                <div class="col-sm-3 col-xs-3">
                                    <img class="img-responsive" src="{{ 'data:image/jpeg;base64,'.$product->options->image }}" />
                                </div>
                                ...
                                <div class="col-sm-3 col-xs-3 text-right">
                                    <h6><span>$</span>{{ number_format($product->qty * $product->price , 0, ',', ' ') }}</h6>
                                </div>
                            </div>
                            @endforeach
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    ...
                                    <div class="pull-right"><span>$</span><span>{{ Cart::subtotal(0, ',', ' ') }}</span></div>
                                </div>
                                <div class="col-xs-12">
                                    <span>Shipping</span>

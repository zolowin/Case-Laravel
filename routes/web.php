...
Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function (){
    ...
    Route::group(['prefix' => 'dashboard', 'middleware' => 'admin'], function (){
        Route::get('/', 'DashboardController@dashboard')->name('dashboard.home');
        ...
        Route::get('/transactions', function (){
            return view('admin.dashboard_transactions');
...
Route::get('/category', 'PageController@category')->name('page.category');
Route::post('/find-product', 'PageController@find')->name('page.find');
